...
let fortuner = new toyotaCar("2026",'20'); // constructor will invoke
let innova = new toyotaCar("2026",'30'); // constructor will invoke
let glanza = new toyotaCar("2027");// constructor will invoke